...
def _build_schema_prompt(message: str, hits: list) -> str:
    ...
    return (
        ...
        "(SalesTerritoryKey, ProductKey, CustomerKey, OrderDateKey, etc.):\n"
        "  WITH AllSales AS (\n"
        "      SELECT 'Internet' AS Canal, OrderDateKey, SalesTerritoryKey, ProductKey,\n"
        "             SalesAmount, TotalProductCost, UnitPrice\n"
        "      FROM dbo.FactInternetSales\n"
        "      UNION ALL\n"
        "      SELECT 'Reseller' AS Canal, OrderDateKey, SalesTerritoryKey, ProductKey,\n"
        "             SalesAmount, TotalProductCost, UnitPrice\n"
        "      FROM dbo.FactResellerSales\n"
        "  )\n"
        "NUNCA hagas JOIN de AllSales a DimSalesTerritory usando OrderDateKey — usa SalesTerritoryKey:\n"
